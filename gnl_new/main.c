...
// sistemare il main in modo che come output abbia OK se l'output e' giusto
// oppure SBAGLIATO se l'output non e' corretto
int main(void)
{
    int     fd;
    char    *line;
    ...
    if (fd == -1)
    {
        printf("Errore nell'apertura del file 42_with_nl\n");
        return (1);
    }
    line_count = 1;
